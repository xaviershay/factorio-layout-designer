...
export const ItemsApiFetchParamCreator = function (configuration?: Configuration) {
    return {
        ...
        /**
         * This request will return a paginated list of all items available in the current combination of mods. The items are sorted by their name.
         * @summary Returns a list of all items.
         * @throws {RequiredError}
         */
        itemList(authorization: string, uNKNOWNBASETYPE: UNKNOWN_BASE_TYPE, acceptLanguage?: string, options: RequestOptions): FetchArgs {
            // verify required parameter 'authorization' is not null or undefined
            if (authorization === null || authorization === undefined) {
                throw new RequiredError('authorization','Required parameter authorization was null or undefined when calling itemList.');
            }
            // verify required parameter 'uNKNOWNBASETYPE' is not null or undefined
            if (uNKNOWNBASETYPE === null || uNKNOWNBASETYPE === undefined) {
                throw new RequiredError('uNKNOWNBASETYPE','Required parameter uNKNOWNBASETYPE was null or undefined when calling itemList.');
            }
            const localVarPath = `/item/list`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions: RequestOptions = Object.assign({}, { method: 'POST' }, options);
            const localVarHeaderParameter = {};
            const localVarQueryParameter = {};
...
export type ItemsApiType = { 
    ...
    itemList(authorization: string, uNKNOWNBASETYPE: UNKNOWN_BASE_TYPE, acceptLanguage?: string, options?: RequestOptions): Promise<Object>,
...
export const ItemsApi = function(configuration?: Configuration, fetch: FetchAPI = portableFetch): ItemsApiType {
    ...
    return {
         ...
         */
        itemList(authorization: string, uNKNOWNBASETYPE: UNKNOWN_BASE_TYPE, acceptLanguage?: string, options?: RequestOptions = {}): Promise<Object> {
            const localVarFetchArgs = ItemsApiFetchParamCreator(configuration).itemList(authorization, uNKNOWNBASETYPE, acceptLanguage, options);
            return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                if (response.status >= 200 && response.status < 300) {
                    return response.json();
                } else {
...
export const RecipesApiFetchParamCreator = function (configuration?: Configuration) {
    return {
        ...
        /**
         * This request will return a paginated list of all recipes available with the current combination of mods. Normal and expensive variant will be grouped together. The recipes are sorted by their name.
         * @summary Returns a list of all available recipes.
         * @throws {RequiredError}
         */
        recipeList(authorization: string, uNKNOWNBASETYPE: UNKNOWN_BASE_TYPE, acceptLanguage?: string, options: RequestOptions): FetchArgs {
            // verify required parameter 'authorization' is not null or undefined
            if (authorization === null || authorization === undefined) {
                throw new RequiredError('authorization','Required parameter authorization was null or undefined when calling recipeList.');
            }
            // verify required parameter 'uNKNOWNBASETYPE' is not null or undefined
            if (uNKNOWNBASETYPE === null || uNKNOWNBASETYPE === undefined) {
                throw new RequiredError('uNKNOWNBASETYPE','Required parameter uNKNOWNBASETYPE was null or undefined when calling recipeList.');
            }
            const localVarPath = `/recipe/list`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions: RequestOptions = Object.assign({}, { method: 'POST' }, options);
            const localVarHeaderParameter = {};
            const localVarQueryParameter = {};
...
export type RecipesApiType = { 
    ...
    recipeList(authorization: string, uNKNOWNBASETYPE: UNKNOWN_BASE_TYPE, acceptLanguage?: string, options?: RequestOptions): Promise<Object>,
...
export const RecipesApi = function(configuration?: Configuration, fetch: FetchAPI = portableFetch): RecipesApiType {
    ...
    return {
         ...
         */
        recipeList(authorization: string, uNKNOWNBASETYPE: UNKNOWN_BASE_TYPE, acceptLanguage?: string, options?: RequestOptions = {}): Promise<Object> {
            const localVarFetchArgs = RecipesApiFetchParamCreator(configuration).recipeList(authorization, uNKNOWNBASETYPE, acceptLanguage, options);
            return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                if (response.status >= 200 && response.status < 300) {
                    return response.json();
                } else {
